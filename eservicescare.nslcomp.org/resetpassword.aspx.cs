        ...
        if (read.HasRows)
        {
            ...
            if (password.Text == confirm_password.Text)
            {
                ...
                try
                {
                    ...
                    //mail.From = new MailAddress("getqueryinfo@gmail.com");
                    mail.Subject = "eServices Care - You are reset your password successfully.";
                    string emailBody = "";
                    ...
                    emailBody += "<p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;color:rgb(41,41,41);line-height:22px;margin:0px'>eServices Care Support</p>";
                    emailBody += "</td>";
                    emailBody += "</tr>";
                    emailBody += "</tbody>";
                    emailBody += "</table>";
