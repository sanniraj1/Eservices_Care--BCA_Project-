<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="addelectrician.aspx.cs" Inherits="admin_addelectrician" %>
                        ...
                        <div class="flot-chart">
                            ...
                            <div class="form-group">        
                              <div class="col-sm-offset-3 col-sm-9">
                                <asp:Button ID="addCarpenter" runat="server" Text="Add Electrician" CssClass="btn btn-primary" OnClick="addElectrician_Click" />
                              </div>
                            </div>
