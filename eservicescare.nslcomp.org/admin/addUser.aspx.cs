...
public partial class admin_addUser : System.Web.UI.Page
{
    ...
    protected void addUser_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            con.Close();
            con.Open();
            string insertCmd = "insert into [registration](first_name,last_name,email,password,mobile,address,photo,gender,created_on,dob) values(@first_name,@last_name,@email_address,@password,@mobile,@address,@photo,@gender,@created_on,@dob)";
