<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="editCarpenter.aspx.cs" Inherits="admin_editCarpenter" %>
                        ...
                        <div class="flot-chart">
                            ...
                            <div class="form-group">        
                              <div class="col-sm-offset-3 col-sm-9">
                                <asp:Button ID="addCarpenter" runat="server" Text="Update" CssClass="btn btn-primary" OnClick="UpdateCArP_Click" />
                              </div>
                            </div>
